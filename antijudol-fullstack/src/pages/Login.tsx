...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: 'Berhasil', description: `Selamat datang, ${data.admin.name}!` });
      navigate('/dashboard');
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/10 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight">ANTI-JUDOL</h1>
          <p className="text-muted-foreground text-sm mt-1">Campus Security System</p>
        </div>
        ...
        <Card className="border-2 shadow-xl shadow-black/5">
          <CardHeader className="pb-4">
            ...
            <CardDescription>
              Login dengan akun admin untuk mengakses monitoring sistem
            </CardDescription>
          </CardHeader>
          <CardContent>
